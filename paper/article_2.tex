...
\\
In this paper we will focus on the gravitational lensing method, which allows to measure $H_0$, as firstly suggested by Refsdal [cita], with a weaker dependence on the cosmological parameters if compared to the CMB analyses.
%------------------------------------------------
